...
public:
    std::string UseFuncA() const override { return "The product A1."; }
};

class ConcreteProductA2 : public AbstractProductA {
    std::string UseFuncA() const override { return "The product A2."; }
};
...
public:
    std::string UseFuncB() const override { return "The product B1."; }
    /**
...
public:
    std::string UseFuncB() const override { return "The product B2."; }
    /**
