...
![创建组合类后的程序库结构](image/创建组合类后的程序库结构.png)
...
![装饰模式解决方案](image/装饰模式解决方案.png)

将各种通知方法放入装饰。

客户端代码必须将基础通知器放入一系列自己所需的装饰中。 因此最后的对象将形成一个栈结构。

![程序可以配置由通知装饰构成的复杂栈](image/程序可以配置由通知装饰构成的复杂栈.png)
